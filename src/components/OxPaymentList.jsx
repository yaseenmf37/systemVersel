...
export default function RedDepositDates() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center py-2">
      <div className="bg-white text-blue-900 shadow-lg rounded-lg p-6 w-full max-w-4xl">
        ...
        <div className="flex justify-around mt-10">
          <div className="flex flex-col items-center gap-4 mb-6">
            ...
            <button
              ...
              className="bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-700 w-full max-w-xs"
            >
              جستجو
            </button>
          </div>
          <div className="flex flex-col items-center gap-4 mb-6">
            <label className="text-gray-800 font-bold">فیش واریزی :</label>
            <select
              value={startDay}
              onChange={(e) => setStartDay(e.target.value)}
              className="border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-500 text-black"
              ...
              <tbody>
                {filteredData.map((item) => (
                  <tr key={item.id} className="bg-gray-100 text-center">
                    ...
                    <td
                      className="border border-gray-300 text-blue-500 hover:underline cursor-pointer p-2"
