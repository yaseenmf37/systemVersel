...
export default function RedReceiptregistrationsystem() {
  return (
    <div className="bg-blue-500 shadow rounded-lg p-6 w-7/12 mx-auto max-sm:w-full my-1">
          ...
          <FormikForm className="space-y-4">
            <div>
              ...
              <Field
                type="text"
                name="lastFourDigits"
                className="bg-blue-100 w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-gray-400 focus:outline-none"
            ...
            <div>
              ...
              <Field
                type="date"
                name="depositDate"
                className="bg-blue-100 text-gray-600 w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-gray-400 focus:outline-none"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full text-blue-500 bg-white font-bold p-6 shadow-lg rounded-md py-2 "
            >
              ثبت اطلاعات
            </button>
          </FormikForm>
